...
Halo! Saya adalah seorang web developer dengan pengalaman dalam membangun berbagai jenis website menggunakan `Laravel` dan `Vue.js`.

## Pengalaman Kerja

Saya memulai karier profesional pada awal 2022 sebagai [**Front-End Web Developer**](https://www.w3schools.com/whatis/whatis_frontenddev.asp) di CV Karya Inovasi Anak Bangsa, Banjarnegara. Di sana, saya terlibat dalam pengembangan website monitoring transaksi keuangan.
...
Sejak Juli 2023, saya mulai berperan sebagai [**Fullstack Developer**](https://www.w3schools.com/whatis/whatis_fullstack.asp) di PT Prioritas Web Teknologi. Dalam peran ini, saya mulai terlibat di bagian backend, seperti pengembangan API dan optimasi performa sistem.
